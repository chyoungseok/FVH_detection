...
def save_eval_plots(y_true: np.ndarray, y_prob: np.ndarray, out_dir: str, prefix: str = "test"):
    ...
    plt.title("Confusion Matrix (thr=0.5)"); plt.tight_layout()
...
def main():
    ...
    save_eval_plots(test_metrics["y_true"], test_metrics["y_prob"], args.out_dir, prefix="test")
