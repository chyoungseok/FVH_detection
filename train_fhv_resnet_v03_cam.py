...
# =========================================================
# Grad-CAM utilities (for 1-channel ResNet18)
# =========================================================
class GradCAM:
...
def main():
    ...
    # Export Grad-CAM overlays for TEST set (one PNG per slice)
    if args.export_cam:
        cam_out = args.cam_dir if args.cam_dir else os.path.join(args.out_dir, "cam_test")
        os.makedirs(cam_out, exist_ok=True)

        # select target module
        target_module = model.layer4 if args.cam_layer == "layer4" else model.layer3
...
'''
python train_fhv_resnet_v03.py   --data_root ./04_flair_preproc_slices   --out_dir ./runs/fhv_resnet18_plateau   --neg_ratio 1.0   --test_ratio 0.3   --val_ratio 0.1   --epochs 100   --batch_size 16   --lr 1e-3   --lr_scheduler plateau --plateau_mode min --plateau_factor 0.5 --plateau_patience 2   --weight_pos 1.3   --amp   --num_workers 0

python train_fhv_resnet_v03_cam.py --data_root ./04_flair_preproc_slices --out_dir ./runs/fhv_resnet18_with_cam --neg_ratio 1.0 --test_ratio 0.3 --val_ratio 0.1 --epochs 100 --batch_size 16 --lr 1e-3 --lr_scheduler plateau --plateau_mode min --plateau_factor 0.5 --plateau_patience 2 --weight_pos 1.2 --amp --num_workers 0 --export_cam --cam_layer layer4 --cam_target pos
